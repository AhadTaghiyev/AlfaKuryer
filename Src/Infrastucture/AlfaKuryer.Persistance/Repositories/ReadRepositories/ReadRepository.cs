...
namespace AlfaKuryer.Persistance.Repositories.ReadRepositories
{
    public class ReadRepository<T> : IReadRepository<T> where T : BaseEntity, new()
    {
        ...
        public async Task<T> GetAsync(Expression<Func<T, bool>> expression, bool IsTracking, bool isrelation, string[] Includes = null)
        {
        ...
        public async Task<IQueryable<T>> GetAllAsync(Expression<Func<T, bool>> expression,bool isTracking, bool isRelation, string[] Includes = null)
        {
            IQueryable<T> query = Table.Where(expression);
