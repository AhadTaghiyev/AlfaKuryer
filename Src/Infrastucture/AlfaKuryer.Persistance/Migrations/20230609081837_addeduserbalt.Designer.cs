...
namespace AlfaKuryer.Persistance.Migrations
{
    ...
    [Migration("20230609081837_addeduserbalt")]
    partial class addeduserbalt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlfaKuryer.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<double?>("CourierSalaryForFast")
                        .HasColumnType("double");

                    b.Property<double?>("CourierSalaryForSimple")
                        .HasColumnType("double");
            ...
            modelBuilder.Entity("AlfaKuryer.Domain.Entities.UserPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AlfaKuryer.Domain.Entities.CourierBalance", b =>
                {
                    ...
                    b.HasOne("AlfaKuryer.Domain.Entities.Order", "Order")
                        .WithMany("CourierBalances")
